...
var LazyImage = (_a) => {
  ...
  if (previewImage) {
    ...
    return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_lazy_images__WEBPACK_IMPORTED_MODULE_4__/* .LazyImageFull */ .AZ, __spreadProps(__spreadValues({
      src
    }, rest), {
      experimentalDecode: true
    }), ({ imageState, ref }) => {
      const isLoaded = imageState === react_lazy_images__WEBPACK_IMPORTED_MODULE_4__/* .ImageState.LoadSuccess */ .zl.LoadSuccess;
      const wrapperStyle = {
        width: "100%"
      };
      const imgStyle = {};
